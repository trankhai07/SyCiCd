  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="syCiCdApp.checkOut.home.createOrEditLabel" data-cy="CheckOutCreateUpdateHeading">
            <Translate contentKey="syCiCdApp.checkOut.home.createOrEditLabel">Create or edit a CheckOut</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('syCiCdApp.checkOut.startTime')}
              ...
              />
              <ValidatedField
                label={translate('syCiCdApp.checkOut.endTime')}
              ...
              />
              <ValidatedField
                label={translate('syCiCdApp.checkOut.status')}
                id="check-out-status"
                name="status"
                data-cy="status"
                type="select"
              >
                {statusValues.map(status => (
                  <option value={status} key={status}>
                    {translate('syCiCdApp.Status.' + status)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('syCiCdApp.checkOut.isReturned')}
              ...
              <ValidatedField
                ...
                name="bookCopy"
                data-cy="bookCopy"
                label={translate('syCiCdApp.checkOut.bookCopy')}
                type="select"
              >
                <option value="" key="0" />
                {bookCopies
              ...
              <ValidatedField
                ...
                label={translate('syCiCdApp.checkOut.patronAccount')}
                type="select"
              >
                <option value="" key="0" />
                {patronAccounts

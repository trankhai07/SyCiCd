...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './check-out.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHECKOUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHECKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHECKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHECKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHECKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHECKOUT actions', async () => {
      const expectedActions = [
        {

    ...
    <Row>
      <Col md="8">
        <h2 data-cy="checkOutDetailsHeading">
          <Translate contentKey="syCiCdApp.checkOut.detail.title">CheckOut</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="startTime">
              <Translate contentKey="syCiCdApp.checkOut.startTime">Start Time</Translate>
            </span>
          </dt>
          <dd>{checkOutEntity.startTime ? <TextFormat value={checkOutEntity.startTime} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="endTime">
              <Translate contentKey="syCiCdApp.checkOut.endTime">End Time</Translate>
            </span>
          </dt>
          <dd>{checkOutEntity.endTime ? <TextFormat value={checkOutEntity.endTime} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="status">
              <Translate contentKey="syCiCdApp.checkOut.status">Status</Translate>
            </span>
          </dt>
          <dd>{checkOutEntity.status}</dd>
          <dt>
            <span id="isReturned">
              <Translate contentKey="syCiCdApp.checkOut.isReturned">Is Returned</Translate>
            </span>
          </dt>
          <dd>{checkOutEntity.isReturned ? 'true' : 'false'}</dd>
          <dt>
            <Translate contentKey="syCiCdApp.checkOut.bookCopy">Book Copy</Translate>
          </dt>
          <dd>{checkOutEntity.bookCopy ? checkOutEntity.bookCopy.id : ''}</dd>
          <dt>
            <Translate contentKey="syCiCdApp.checkOut.patronAccount">Patron Account</Translate>
          </dt>

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="syCiCdApp.bookCopy.home.createOrEditLabel" data-cy="BookCopyCreateUpdateHeading">
            <Translate contentKey="syCiCdApp.bookCopy.home.createOrEditLabel">Create or edit a BookCopy</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('syCiCdApp.bookCopy.yearPublished')}
              ...
              />
              <ValidatedField
                label={translate('syCiCdApp.bookCopy.amount')}
                id="book-copy-amount"
                name="amount"
                data-cy="amount"
                type="text"
              />
              <ValidatedField label={translate('syCiCdApp.bookCopy.image')} id="book-copy-image" name="image" data-cy="image" type="text" />
              <ValidatedField
                label={translate('syCiCdApp.bookCopy.description')}
                id="book-copy-description"
                name="description"
                data-cy="description"
                type="text"
              />
              <ValidatedField id="book-copy-book" name="book" data-cy="book" label={translate('syCiCdApp.bookCopy.book')} type="select">
                <option value="" key="0" />
                {books
              ...
              <ValidatedField
                ...
                name="publisher"
                data-cy="publisher"
                label={translate('syCiCdApp.bookCopy.publisher')}
                type="select"
              >
                <option value="" key="0" />
                {publishers

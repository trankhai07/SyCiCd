    ...
    <Row>
      <Col md="8">
        <h2 data-cy="bookCopyDetailsHeading">
          <Translate contentKey="syCiCdApp.bookCopy.detail.title">BookCopy</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="yearPublished">
              <Translate contentKey="syCiCdApp.bookCopy.yearPublished">Year Published</Translate>
            </span>
          </dt>
          <dd>{bookCopyEntity.yearPublished}</dd>
          <dt>
            <span id="amount">
              <Translate contentKey="syCiCdApp.bookCopy.amount">Amount</Translate>
            </span>
          </dt>
          <dd>{bookCopyEntity.amount}</dd>
          <dt>
            <span id="image">
              <Translate contentKey="syCiCdApp.bookCopy.image">Image</Translate>
            </span>
          </dt>
          <dd>{bookCopyEntity.image}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="syCiCdApp.bookCopy.description">Description</Translate>
            </span>
          </dt>
          <dd>{bookCopyEntity.description}</dd>
          <dt>
            <Translate contentKey="syCiCdApp.bookCopy.book">Book</Translate>
          </dt>
          <dd>{bookCopyEntity.book ? bookCopyEntity.book.title : ''}</dd>
          <dt>
            <Translate contentKey="syCiCdApp.bookCopy.publisher">Publisher</Translate>
          </dt>

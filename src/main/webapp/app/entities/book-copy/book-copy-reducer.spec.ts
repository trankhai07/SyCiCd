...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './book-copy.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKCOPY_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOOKCOPY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOOKCOPY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOOKCOPY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOOKCOPY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOOKCOPY actions', async () => {
      const expectedActions = [
        {

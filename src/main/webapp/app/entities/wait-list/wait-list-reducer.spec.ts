...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wait-list.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WAITLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_WAITLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WAITLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WAITLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WAITLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WAITLIST actions', async () => {
      const expectedActions = [
        {

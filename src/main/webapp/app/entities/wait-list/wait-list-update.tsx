  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="syCiCdApp.waitList.home.createOrEditLabel" data-cy="WaitListCreateUpdateHeading">
            <Translate contentKey="syCiCdApp.waitList.home.createOrEditLabel">Create or edit a WaitList</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('syCiCdApp.waitList.creatAt')}
              ...
              <ValidatedField
                ...
                label={translate('syCiCdApp.waitList.patronAccount')}
                type="select"
              >
                <option value="" key="0" />
                {patronAccounts
              ...
              <ValidatedField id="wait-list-book" name="book" data-cy="book" label={translate('syCiCdApp.waitList.book')} type="select">
                <option value="" key="0" />
                {books

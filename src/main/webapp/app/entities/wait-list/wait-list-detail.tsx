    ...
    <Row>
      <Col md="8">
        <h2 data-cy="waitListDetailsHeading">
          <Translate contentKey="syCiCdApp.waitList.detail.title">WaitList</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="creatAt">
              <Translate contentKey="syCiCdApp.waitList.creatAt">Creat At</Translate>
            </span>
          </dt>
          <dd>{waitListEntity.creatAt ? <TextFormat value={waitListEntity.creatAt} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <Translate contentKey="syCiCdApp.waitList.patronAccount">Patron Account</Translate>
          </dt>
          <dd>{waitListEntity.patronAccount ? waitListEntity.patronAccount.cardNumber : ''}</dd>
          <dt>
            <Translate contentKey="syCiCdApp.waitList.book">Book</Translate>
          </dt>

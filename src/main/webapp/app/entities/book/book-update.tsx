  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="syCiCdApp.book.home.createOrEditLabel" data-cy="BookCreateUpdateHeading">
            <Translate contentKey="syCiCdApp.book.home.createOrEditLabel">Create or edit a Book</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('syCiCdApp.book.title')}
                id="book-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField label={translate('syCiCdApp.book.image')} id="book-image" name="image" data-cy="image" type="text" />
              <ValidatedField
                label={translate('syCiCdApp.book.description')}
                id="book-description"
                name="description"
                data-cy="description"
                type="text"
              />
              <ValidatedField
                label={translate('syCiCdApp.book.author')}
                id="book-author"
                data-cy="author"
                type="select"
                multiple
              ...
              <ValidatedField
                ...
                name="category"
                data-cy="category"
                label={translate('syCiCdApp.book.category')}
                type="select"
              >
                <option value="" key="0" />
                {categories

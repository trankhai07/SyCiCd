...
import { getEntities } from './patron-account.reducer';
  ...
  return (
    <div>
      <h2 id="patron-account-heading" data-cy="PatronAccountHeading">
        <Translate contentKey="syCiCdApp.patronAccount.home.title">Patron Accounts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="syCiCdApp.patronAccount.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/patron-account/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="syCiCdApp.patronAccount.home.createLabel">Create new Patron Account</Translate>
          </Link>
        </div>
      </h2>
        ...
        {patronAccountList && patronAccountList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('cardNumber')}>
                  <Translate contentKey="syCiCdApp.patronAccount.cardNumber">Card Number</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="syCiCdApp.patronAccount.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="syCiCdApp.patronAccount.home.notFound">No Patron Accounts found</Translate>
            </div>
          )
        )}
      </div>

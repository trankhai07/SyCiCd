...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PATRONACCOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PATRONACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PATRONACCOUNT actions', async () => {
      const expectedActions = [
        {
      ...
      await store.dispatch(createEntity({ cardNumber: 'CBA' }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
      expect(store.getActions()[2]).toMatchObject(expectedActions[2]);
    });

    it('dispatches UPDATE_PATRONACCOUNT actions', async () => {
      const expectedActions = [
        {
      ...
      await store.dispatch(updateEntity({ cardNumber: 'CBA' }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
      expect(store.getActions()[2]).toMatchObject(expectedActions[2]);
    });

    it('dispatches PARTIAL_UPDATE_PATRONACCOUNT actions', async () => {
      const expectedActions = [
        {
      ...
      await store.dispatch(partialUpdateEntity({ cardNumber: 'ABC' }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
      expect(store.getActions()[2]).toMatchObject(expectedActions[2]);
    });

    it('dispatches DELETE_PATRONACCOUNT actions', async () => {
      const expectedActions = [
        {

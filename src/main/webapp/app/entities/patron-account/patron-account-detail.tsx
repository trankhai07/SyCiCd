    ...
    <Row>
      <Col md="8">
        <h2 data-cy="patronAccountDetailsHeading">
          <Translate contentKey="syCiCdApp.patronAccount.detail.title">PatronAccount</Translate>
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="cardNumber">
              <Translate contentKey="syCiCdApp.patronAccount.cardNumber">Card Number</Translate>
            </span>
          </dt>
          <dd>{patronAccountEntity.cardNumber}</dd>
          <dt>
            <Translate contentKey="syCiCdApp.patronAccount.user">User</Translate>
          </dt>

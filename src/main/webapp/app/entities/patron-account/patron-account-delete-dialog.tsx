...
export const PatronAccountDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="syCiCdApp.patronAccount.delete.question">
        <Translate contentKey="syCiCdApp.patronAccount.delete.question" interpolate={{ id: patronAccountEntity.cardNumber }}>

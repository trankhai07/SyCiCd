  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="syCiCdApp.notification.home.createOrEditLabel" data-cy="NotificationCreateUpdateHeading">
            <Translate contentKey="syCiCdApp.notification.home.createOrEditLabel">Create or edit a Notification</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('syCiCdApp.notification.sentAt')}
              ...
              />
              <ValidatedField
                label={translate('syCiCdApp.notification.type')}
              ...
              <ValidatedField
                ...
                label={translate('syCiCdApp.notification.patronAccount')}
                type="select"
              >
                <option value="" key="0" />
                {patronAccounts

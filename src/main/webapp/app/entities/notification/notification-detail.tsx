    ...
    <Row>
      <Col md="8">
        <h2 data-cy="notificationDetailsHeading">
          <Translate contentKey="syCiCdApp.notification.detail.title">Notification</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="sentAt">
              <Translate contentKey="syCiCdApp.notification.sentAt">Sent At</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="type">
              <Translate contentKey="syCiCdApp.notification.type">Type</Translate>
            </span>
          </dt>
          <dd>{notificationEntity.type}</dd>
          <dt>
            <Translate contentKey="syCiCdApp.notification.patronAccount">Patron Account</Translate>
          </dt>
